...
const MODULE_REFERENCES = {
  ...
  shows: [
    ...
    "references/shows/book-interpretation.md",
    "references/shows/infinite-game.md",
    "references/shows/huichang-ai.md",
    "references/shows/casual-chat.md",
  ],
  copywriting: ["references/shows/README.md"],
